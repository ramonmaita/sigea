...
<head>
    ...
    <title>SOLICITUD DE DESINCORPORACION DE BIENES N° {{ $solicitud->numero_solicitud_des }}</title>
    <style>
        @page {
            margin-top: 120px;
...
<body>
    ...
    <main class="content">
        <div class="bold text-center" style="font-size: 12pt; margin-bottom: 5px;">SOLICITUD DE DESINCORPORACION
            DE BIENES
        </div>
        <br>
        ...
        <table border="1" cellspacing="0" ceelpadding="0">
            <tr>
                <td colspan="2" style="width: 31%"><span class="titulos">1.UNIDAD SOLICITANTE:</span><br>
                    {{ $detalleOficina->nombre_oficina }}</td>
                <td><span class="titulos">2.Nº.:</span><br> {{ $solicitud->numero_solicitud_des }}</td>
            </tr>
            <tr>
                <td style="width: 50%"><span class="titulos">3.NOMBRE Y APELLIDO:</span><br> {{ $nombreSolicitante }}
                </td>
                <td><span class="titulos">C.I:</span><br> {{ $cedulaSolicitante }}</td>
                <td><span class="titulos">4. FECHA:</span><br> {{ $solicitud->fecha_solicitud->format('d/m/Y') }}</td>
            </tr>
        </table>
        <br><br>
        ...
        <table class="item-table" border="1">
            <thead>
                <tr>
                    ...
                    <th style="width:15%;">6. SERIALES</th>
                    <th style="width:10%;">7. NÚMERO DE INVENTARIO</th>
                    <th style="width:40%;">8. DESCRIPCIÓN</th>
                    <th style="width:15%;">9. VALOR</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table
            ...
            <tr>
                <td class="field-label text-right">10. TOTAL ({{ $nombre_moneda }}):</td>
        ...
        <table border="1">
            ...
            <tr>
                <th align="center" valign="top" style="width:25%; height: 100px;">11. UNIDAD SOLICITANTE:</th>
                <th align="center" valign="top" style="width:25%; height: 100px;">12. BIENES PUBLICOS</th>
                <th align="center" valign="top" style="width:25%; height: 100px;">13. OFICINA DE GESTION
                    ADMINISTRATIVA</th>
            </tr>
        </table>
